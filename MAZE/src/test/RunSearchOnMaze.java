    ...
    public static void printMazeWithSolution(Maze maze, Solution solution) {
        ...
        for (AState state : solutionPath) {
            if (state instanceof MazeState) {
                ...
                displayMaze[mazeState.getR()][mazeState.getC()] = '█';
        ...
        displayMaze[startPosition.getRowIndex()][startPosition.getColumnIndex()] = 'S'; // Start position
        displayMaze[goalPosition.getRowIndex()][goalPosition.getColumnIndex()] = 'E';   // End position
